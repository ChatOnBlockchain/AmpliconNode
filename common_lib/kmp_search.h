...
namespace common_lib {
    class kmp_search {
    public:
        kmp_search(const std::string &query, bool enable_reverse_order_search = false);
    ...
    private:
        ...
        int _perform_kmp_search(const std::string &input, const std::string &query, const std::vector<int> *kmp_table,
